...
public class BossTankController : MonoBehaviour
{
	...
	void SetLightAttackState()
	{
		...
		m_LightShootParticles.GetComponent<ParticleSystem>().Stop();
		m_LightShootParticles.GetComponent<ParticleSystem>().Play();
	...
	void SetHeavyAttackState()
	{
		...
		m_HeavyShootParticles.GetComponent<ParticleSystem>().Stop();
		m_HeavyShootParticles.GetComponent<ParticleSystem>().Play();
